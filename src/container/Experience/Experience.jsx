  ...
  const allData = [
    {
      ...
      data:[
        ...
        {name: `SVKM's Shri Bhagubhai Mafatlal Polytechnic`, degree: 'Diploma', major:'Computer Engineering', duration:'Sept 2014 - June 2018'}
      ]
    },
    {
      title: 'Experience', 
      data:[
        ...
        {name: 'I2E Consulting Pvt Ltd', title:'Web Developer', desc:`Collaborated on the creation of the Internal Recognition Platform "Pats!" using React, PHP, and JavaScript, boosting peer-to-peer recognition. Additionally, development of newsletters with Microsoft Dynamics, increasing stakeholder engagement, and contributed to improving client websites with WordPress and React, enhancing functionality. Moreover, I revitalized the Official I2E website, resulting in a 25% increase in traffic and a 10% boost in user interaction through implemented blogs and forms.`, duration:'Aug 2021 - Dec 2021'},
        {name: 'Perfect Traders', title: 'Web Developer', desc: 'Led a team of developers, overseeing real-time data updates, interactive mapping, and user feedback resolution. Designed and developed the Covi-Check website using PHP, HTML5, CSS3, and Apache, ensuring a responsive and user-friendly interface. Implemented dynamic features with JavaScript and AJAX, enhancing interactivity. Designed and maintained a MySQL database for efficient COVID-19 data management. Provided ongoing support, addressing user feedback, and implementing feature enhancements. Authored a comprehensive user manual for Covi-Check, offering clear instructions. Additionally, developed a client management portal using React, HTML5, CSS3, Tailwind CSS, Node.js, Express.js, and MongoDB, enabling company employees to manage client details, track site work, and securely save payment information.', duration:'June 2020 - Aug 2021'},
